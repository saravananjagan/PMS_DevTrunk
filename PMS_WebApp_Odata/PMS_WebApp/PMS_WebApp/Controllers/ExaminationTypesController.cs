...
namespace PMS_WebApp.Controllers
{
    ...
    */
    public class ExaminationTypesController : ODataController
    {
        ...
        [EnableQuery]
        public SingleResult<ExaminationType> GetExaminationType([FromODataUri] Guid id)
        {
            return SingleResult.Create(db.ExaminationTypes.Where(examinationType => examinationType.ExaminationTypeId == id));
        }
